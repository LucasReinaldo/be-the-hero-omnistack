...
const Detail = () => {
    ...
    const message = `Hello there, ${incident.name}, hope you are doing well. I'm getting in touch because I'd like to help in the incident ${incident.title}, with the amount of ${ Intl.NumberFormat('en', { style: 'currency', currency: 'EUR'}).format(incident.value) }`;
